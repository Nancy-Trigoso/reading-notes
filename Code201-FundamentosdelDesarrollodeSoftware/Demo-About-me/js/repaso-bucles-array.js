// en un array o lista se cuenta desde cero
...
personas.pop(); //pop elimina el ultimo elemento
personas.pop();
personas.pop();
...
//.length se ve la cantidad de eleentos  
// i++
// i = i + 1
// i += 1
...
// recomendacion: usar camellCase cuando creemos variable  nombreDeAlumno - promedioFinal
